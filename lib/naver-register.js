...
export async function registerNaverSites({
  ...
  step(`registerNaverSites: sites=${sites.length}, headless=${headless}, metaInjectOnly=${metaInjectOnly}, extraRedeploy=${extraRedeployOnMiss}, account=${naverAccount?.id || '없음'}, apiKey=${openaiApiKey ? '설정됨' : '없음'}`);
